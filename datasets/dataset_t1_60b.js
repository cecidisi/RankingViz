...
function getDataset_t1_60b() {

    var dataset =
        {
            "query":"women in workforce",
            "dataset-id" : "T1-60b",
            "description" : "Topic 1- 60 items B",
...
[
  ...
  },
  {
    ...
    "creator": "Mary E. Wade",
    "description": "Introducing the concepts of self- and other-advocacy should prove useful as a means of understanding the different contexts in which women and men can effectively and comfortably exert power and influence when making requests. In this conceptual paper, social psychological research is reviewed demonstrating that women can advocate effectively on behalf of others without incurring costs, but gender-linked stereotypes, roles, and norms constrain them from advo- cating as freely and effectively for themselves. It is argued that women do not frequently make requests for them- selves, because they have learned that they may ultimately lose more than they gain. This gendered difference has implications for ongoing pay and promotion inequities.",
  ...
  },
  {
    ...
    "description": "Although it has been suggested that women negotiate over salaries less frequently than men, there is little empirical evidence on this point. Moreover, outside of laboratory settings, there are no investigations of whether, or to what extent, such negotiations actually pay off in higher salary outcomes for either men or women. The salary negotiating behaviors and starting salary outcomes of 205 graduating MBA students were investigated within a power and dependence theoretical frame- work. Results did not support the notion that women negotiate less than men. However, women did obtain lower monetary returns from negotiation (4.3% starting salary increment for men versus 2.7% for women). Over the course of a career, the accumulation of such differences may be substan- tial. Implications and suggestions for future research are discussed.",
  ...
  {
    "id": "c0038cae-a373-3b20-b00f-83b3d8c9fc14",
    "title": "Unionism and the dispersion of wages among blue-collar women",
    "uri": "http://www.mendeley.com/research/unionism-dispersion-wages-among-bluecollar-women/",
    "eexcessURI": "http://www.mendeley.com/research/unionism-dispersion-wages-among-bluecollar-women/",
    "creator": "David A. MacPherson, James B. Stewart",
    "description": "This study examines the effect of trade unionism on the dispersion of wages among male wage and salary workers in the private sector in the United States. It finds that the application of union wage policies designed to standardize rates within and across establishments significantly reduces wage dispersion among workers covered by union contracts and that unions further reduce wage dispersion by narrowing the white-collar/blue-collar differential within establishments. These effects dominate the more widely studied impact of unionism on the dispersion of average wages across industries, so that on net unionism appears to reduce rather than increase wage dispersion or inequality in the United States.",
    "collectionName": "Journal of Labor Research",
    "facets": {
      "provider": "mendeley",
      "type": "unkown",
      "language": "unkown",
  ...
  {
    "id": "d9dcfd20-25a8-360e-b3c1-d236507ab391",
    "title": "Minimum wages and earnings inequality in urban mexico",
    "uri": "http://www.mendeley.com/research/minimum-wages-earnings-inequality-urban-mexico/",
    "eexcessURI": "http://www.mendeley.com/research/minimum-wages-earnings-inequality-urban-mexico/",
    "creator": "Mariano Bosch, Marco Manacorda",
    "description": "This paper analyzes the contribution of the minimum wage to the well documented rise in earnings inequality in Mexico between the late 1980s and the early 2000s. We find that a substantial part of the growth in inequality, and essentially all of the growth in inequality in the bottom end of the distribution, is due to the steep decline in the real value of the minimum wage.",
    "collectionName": "American Economic Journal: Applied Economics",
    "facets": {
      "provider": "mendeley",
      "type": "unkown",
      "language": "unkown",
